...
technical data per wine — **found on the live product pages and now on 31 of 32
product pages** (alcohol, sugar, acidity, volatile, SO₂, extract, classification,
storage, serving); harvest dates, awards and ageing potential still wait for
structured data; confirmation of the Culture 133 000 Ft
