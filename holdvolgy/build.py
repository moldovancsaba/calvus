...
C = {
 "hu": dict(lang="hu", title="Holdvölgy — tokaji borok Mádról · Év pincészete 2026",
   ...
   age_q="Betöltötted már a 18. életéved?", age_note="Weboldalunkat csak 18 éven felüliek látogathatják.", yes="Igen", no="Nem"),
 "en": dict(lang="en", title="Holdvölgy — Tokaji wines from Mád · Winery of the Year 2026",
   ...
   age_q="Are you 18 or older?", age_note="This website may only be visited by adults.", yes="Yes", no="No"),
}
