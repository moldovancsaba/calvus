...
|---|---|
| `handover.md` | where the project stands on 2026-09-21: the inputs read, the Figma frames described, the market measurements, what is not done, the questions |

The standard documentation set (brief, research, audit, sources, decisions, design,
build log, gate, technical package) is created as each stage is reached.
