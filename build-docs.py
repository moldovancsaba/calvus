...
for r in ["holdvolgy/docs/build.py", "idbc-salary-guide/docs/build.py", "discountdirect/build-docs.py", "lexodont.hu/docs/build.py", "business-direct/docs/build.py", "bizdrankazoldet/docs/build.py"]:
    print(f"== {r}")
