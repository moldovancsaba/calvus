...
# The repo-level method document, rendered in the hub's own look.
import re, markdown
md = (ROOT / "PROTOTYPING.md").read_text(encoding="utf-8")
...
<body><div class="wrap">
<div class="top"><b>Calvus</b><a href="index.html">Project Hub</a><a href="holdvolgy/docs/index.html">Holdvölgy docs</a><a href="discountdirect/docs.html">DiscountDirect docs</a><a href="idbc-salary-guide/docs/index.html">IDBC docs</a><a href="lexodont.hu/docs/index.html">Lexodont docs</a></div>
<h1>{title}</h1>
{body}
<footer>Source: <code>PROTOTYPING.md</code>, rendered by <code>build-docs.py</code>.</footer>
</div></body></html>
"""
(ROOT / "prototyping.html").write_text(html, encoding="utf-8")
print("== prototyping.html", len(html), "bytes")
