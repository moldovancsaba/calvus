...
PAGES = [  # (source, output, nav label) — the final set (D44)
    ...
    ('01-research.md', 'research.html', 'Evidence · Research I'),
    ('01b-research-acquisition-content-sales.md', 'research-2.html', 'Evidence · Research II'),
    ('01c-research-data-driven-marketing.md', 'research-3.html', 'Evidence · Research III'),
    ('01e-research-responsible-data.md', 'research-4.html', 'Evidence · Research IV'),
    ('01f-research-beyond-children.md', 'research-5.html', 'Evidence · Research V'),
    ('01g-research-real-system.md', 'research-6.html', 'Evidence · Research VI'),
    ('05-layout-specs.md', '05-layout-specs.html', 'Layout specs'),
    ('decisions.md', 'decisions.html', 'History · Decisions'),
    ('build-log.md', 'build-log.html', 'History · Build log'),
    ('gate.md', 'gate.html', 'History · Gate'),
    ('register-of-asks.md', 'register-of-asks.html', 'History · Register of asks'),
    ('logic-audit.md', 'logic-audit.html', 'History · Logic audit'),
    ('documentation-audit.md', 'documentation-audit.html', 'History · Documentation audit'),
]
