...
The round's findings and fixes are in `06-build-log.md`. Rounds 3–8 (phase 2 and 3 screens, economics, the research and the audit implemented,
the policy screen) were measured at 390 and 1440; 768 and 1024 inherit the same grids (`05-layout-specs.md`).
