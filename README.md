...
| `business-direct/` | Automated marketing machine for B2B2C listing platforms (the one-person sales and marketing team for a listed business; platform, business and consumer views; digests, activation, generated pages, campaigns; optional AI; intelligence dashboard; integrations). Sibling of DiscountDirect. Real data: 431 listings pulled from sport.doneisbetter.com's public API by `data/fetch-sportolok.py`. `docs/` holds brief, sourced research, audit, decisions and the gate-1 design system | Stage 0–2 done 2026-09-19; design system PROPOSED, awaiting gate 1 |
