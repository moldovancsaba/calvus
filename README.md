...
| `nepszabadsag/` | Népszabadság — the relaunch of the daily as an online paper with a weekly print edition, launching 2026-10-08: a pre-registration landing page (the client's memo) and the site (címlap, rovatfront, cikkoldal, Népszava márkafront, from the client's Figma). `docs/handover.md` is where it stands | Opened 2026-09-21: inputs read, the market measured; next: the research proper, then the design-system gate |
