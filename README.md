...
| `nepszabadsag/` | Népszabadság — the relaunch of the daily as an online paper with a weekly print edition, launching 2026-10-08: a pre-registration landing page (the client's memo) and the site (címlap, rovatfront, cikkoldal, Népszava márkafront, from the client's Figma). `docs/` holds the brief, research (a 25-site technical and rendered-layout benchmark, Reuters Institute DNR 2026, subscription benchmarks, the 2016 closure sourced, comparable relaunch cases), the audit (nepszava.hu measured in depth) and sources | Brief, research and audit written 2026-09-21; next: the owner's direction approval, then the design-system gate |
