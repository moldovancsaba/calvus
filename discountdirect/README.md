...
Rendered pages: `docs.html` (this file), `bemutato.html`, `executive.html`, `research.html`,
`audit.html`, `sources.html`, `business-logic.html`, `design.html`, `build-log.html`,
`gate.html`, `client-asks.html`, `ssot.html`, `architecture.html`, `technical-design.html`,
`implementation-plan.html` — generated by `build-docs.py` (`python3 discountdirect/build-docs.py`,
needs the `markdown` package). The prototype is `index.html`.
